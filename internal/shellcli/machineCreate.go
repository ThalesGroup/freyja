...
var machineCreateCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		// TODO :
		//   - fix a bug :
		//     - `machine create` command with complete conf, with networks config, but wrong names in machine networks
		//     - the creation will fail with "no network with name"
		//	   - fix the names in machine networks
		//     - recreate
		//     - the creation will fail because network was not activated
