...
| networks[].bridge       | No              | String       | virbr0                             | Name of the host bridge to attach this network.                                                                                                                                     |
| networks[].interface    | No              | String       | Switch to default bridge mode      | Name of the host interface to attach this network in NAT mode.                                                                                                                      |
