...
* [Ubuntu releases](https://cloud-images.ubuntu.com/releases/)
* [Centos releases](https://cloud.centos.org/centos/)
...
## Apparmor profile libvirt failure
...
1. apparmor="DENIED" operation="file_mmap" profile="virt-aa-helper" name="/opt/openssl/lib/libcrypto.so
2. TODO
